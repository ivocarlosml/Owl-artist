...
document.addEventListener("DOMContentLoaded", function () {
    ...
    imagem.addEventListener("click", function () {
        if (imagem.src.endsWith("http://localhost/Owl-artist/public/assets/coracaoBranco.png")) {
            imagem.classList.add("hidden"); // Adiciona a classe "hidden" para iniciar a animação
            setTimeout(function () {
                imagem.src = "http://localhost/Owl-artist/public/assets/coracaoVermelho.png";
            ...
            setTimeout(function () {
                imagem.src = "http://localhost/Owl-artist/public/assets/coracaoBranco.png";
